(function (global, factory) {
  ...
  const getGatewayState = (msg) => {
    ...
    if (
      (_b =
        (_a = msg === null || msg === void 0 ? void 0 : msg.result) === null ||
        _a === void 0
          ? void 0
      ...
      stateResult =
        (_d =
          (_c = msg === null || msg === void 0 ? void 0 : msg.result) ===
            null || _c === void 0
            ? void 0
    ...
    if (
      (_e = msg === null || msg === void 0 ? void 0 : msg.params) === null ||
      _e === void 0
        ? void 0
        : _e.state
    ) {
      stateParam =
        (_f = msg === null || msg === void 0 ? void 0 : msg.params) === null ||
        _f === void 0
          ? void 0
          : _f.state;
    }
      ...
      this._wsClient.onmessage = (event) => {
        ...
        if (
          GatewayStateType[
            `${
              (_b =
                (_a = msg === null || msg === void 0 ? void 0 : msg.result) ===
                  null || _a === void 0
                  ? void 0
                  : _a.params) === null || _b === void 0
                ? void 0
  ...
  const setMediaElementSinkId = (tag, deviceId) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const element = findElementByType(tag);
      if (element === null) {
  ...
  const getUserMedia$1 = (constraints) =>
    __awaiter(void 0, void 0, void 0, function* () {
  ...
  const _constraintsByKind = (kind = null) => {
    return {
      audio:
        !kind || kind === DeviceType.AudioIn || kind === DeviceType.AudioOut,
      video: !kind || kind === DeviceType.Video,
    };
  };
  const getDevices = (kind = null, fullList = false) =>
    __awaiter(void 0, void 0, void 0, function* () {
      let devices = [];
  ...
  const scanResolutions = (deviceId) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const supported = [];
  ...
  const getMediaConstraints = (options) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      if (micId) {
        micId = yield assureDeviceId(micId, micLabel, DeviceType.AudioIn).catch(
          (error) => null
        );
        if (micId) {
      ...
      if (camId) {
        camId = yield assureDeviceId(camId, camLabel, DeviceType.Video).catch(
          (error) => null
        );
        if (camId) {
  ...
  const assureDeviceId = (id, label, kind) =>
    __awaiter(void 0, void 0, void 0, function* () {
  ...
  const checkDeviceIdConstraints = (id, label, kind, constraints) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const { deviceId } = constraints;
      if (!isDefined(deviceId) && (id || label)) {
        const deviceId = yield assureDeviceId(id, label, kind).catch(
          (error) => null
        );
        if (deviceId) {
  ...
  class Peer {
    ...
    createPeerConnection() {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        this.options.localStream = yield this._retrieveLocalStream().catch(
          (error) => {
  ...
  var pkg = {
    ...
    "release-it": {
      ...
      github: {
        ...
        releaseNotes:
          "git log $(git describe --tags --abbrev=0)..HEAD --pretty=format:'%s' | grep -i -E '^(feat|fix|docs|refactor|chore)'",
      },
    },
    "lint-staged": {
  ...
  class BaseCall {
        ...
        switch (action) {
          case "bootObj": {
            ...
            for (const i in data) {
              participants.push(
                Object.assign(
                  { callId: data[i][0], index: Number(i) },
          ...
          case "add": {
            this._dispatchConferenceUpdate(
              Object.assign(
                { action: ConferenceAction.Add, callId, index },
          ...
          case "modify":
            this._dispatchConferenceUpdate(
              Object.assign(
                { action: ConferenceAction.Modify, callId, index },
                mutateLiveArrayData(data)
              )
            );
            break;
          case "del":
            this._dispatchConferenceUpdate(
              Object.assign(
                { action: ConferenceAction.Delete, callId, index },
                mutateLiveArrayData(data)
              )
            );
            break;
    ...
    _addChannel(channel) {
      ...
      if (this.session._existsSubscription(protocol, channel)) {
        this.session.subscriptions[protocol][channel] = Object.assign(
          Object.assign({}, this.session.subscriptions[protocol][channel]),
          { callId: this.id }
        );
      }
    }
    ...
    _dispatchConferenceUpdate(params) {
      this._dispatchNotification(
        Object.assign(
          { type: NOTIFICATION_TYPE.conferenceUpdate, call: this },
          params
        )
      );
    }
  ...
  class BrowserSession extends BaseSession {
    ...
    disconnect() {
      ...
      return __awaiter(this, void 0, void 0, function* () {
        Object.keys(this.calls).forEach((k) =>
          this.calls[k].setState(State.Purge)
        );
        this.calls = {};
    ...
    setAudioSettings(settings) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const { micId, micLabel } = settings,
          constraints = __rest(settings, ["micId", "micLabel"]);
        removeUnsupportedConstraints(constraints);
        this._audioConstraints = yield checkDeviceIdConstraints(
          micId,
          micLabel,
          "audioinput",
          constraints
    ...
    setVideoSettings(settings) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const { camId, camLabel } = settings,
          constraints = __rest(settings, ["camId", "camLabel"]);
        removeUnsupportedConstraints(constraints);
        this._videoConstraints = yield checkDeviceIdConstraints(
          camId,
          camLabel,
          "videoinput",
          constraints
  ...
  class VertoHandler {
    ...
    handleMessage(msg) {
      ...
      const callID =
        params === null || params === void 0 ? void 0 : params.callID;
      const eventChannel =
        params === null || params === void 0 ? void 0 : params.eventChannel;
      const eventType =
        params === null || params === void 0 ? void 0 : params.eventType;
          ...
          case "conference-liveArray-part": {
            ...
            if (laChannel && session._existsSubscription(protocol, laChannel)) {
              ...
              if (callId !== null) {
                ...
                if (
                  !trigger(SwEvent.Notification, notification, callId, false)
                ) {
                  trigger(SwEvent.Notification, notification, session.uuid);
                }
                if (call === null) {
